...
router.post("/change-password", (0, authorize_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.USER), (0, handleZodValidation_1.default)(auth_validation_1.changePasswordZod), auth_controller_1.authController.changePassword);
